			...
			<div className="container mx-auto max-w-7xl">
				...
				>
					<div className="flex items-center justify-center gap-3 mb-4">
						<motion.div
							className="h-1 w-12 bg-accentOrange"
					...
					<motion.p
						className="text-mediumGray font-zilla text-lg md:text-xl max-w-2xl mx-auto"
						...
						viewport={{ once: true }}
					>
						Comprehensive transport solutions with speed, safety,
				...
				<div className="flex justify-center mt-12">
					...
					>
						...
						<p className="text-lg md:text-xl leading-relaxed text-mediumGray font-zilla text-center">
							Need something specific? I also offer tailored
							transport solutions to meet your unique
							requirements. Whether you need to transport special
							equipment, oversized items, or a custom group tour,
							I can create a plan to suit your needs.
						</p>
					</motion.div>
				</div>
			</div>
